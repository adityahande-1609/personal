...
export default function App(){return <BrowserRouter><header className="nav"><Link className="brand" to="/">rentwise</Link><nav><Link to="/properties">Find a home</Link><Link to="/services">Services</Link><Link to="/about">About</Link><Link to="/login">Log in</Link><Link className="button small" to="/register">Get started</Link></nav></header><Routes>
  ...
  <Route path="/owner/dashboard" element={<Dashboard role="OWNER"/>}/><Route path="/tenant/dashboard" element={<Dashboard role="TENANT"/>}/>
