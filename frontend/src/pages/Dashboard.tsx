...
export default function Dashboard({role}:{role:'OWNER'|'TENANT'}) {
  ...
  const labels = role === 'OWNER' ? ['Active listings','Open enquiries','Upcoming visits'] : ['Saved properties','Visit requests','Enquiries'];
